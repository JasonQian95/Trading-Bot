...
sp500_full_table_path = utils.get_file_path(config.sp500_symbols_data_path, sp500_full_table_filename, config.sp500)
sp500_symbols_table_path = utils.get_file_path(config.sp500_symbols_data_path, sp500_symbols_table_filename, config.sp500)
